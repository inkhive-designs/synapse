...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-12 col-sm-12 grid maximum'); ?>>
    ...
    <div class="out-thumb col-md-6 col-sm-6">
        <header class="entry-header">
            ...
            <div class="postedon"><?php synapse_posted_on_icon('both'); ?></div>
            <div class="entry-excerpt"><?php echo substr(get_the_excerpt(),0,80).(get_the_excerpt() ? "..." : "" ); ?></div>
            <div class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','synapse'); ?></a></div>
        </header><!-- .entry-header -->
    </div><!--.out-thumb-->
